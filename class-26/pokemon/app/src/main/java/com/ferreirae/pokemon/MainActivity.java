...
import type.ModelPokemonFilterInput;
...
//        });
    ...
    protected void onResume() {
        ...
        ListPokemonsQuery query = ListPokemonsQuery.builder()
                .filter(ModelPokemonFilterInput.builder()
                        .name(ModelStringFilterInput.builder()
                                .eq("Bulbasaur")
                                .build())
                        .build())
                .build();
